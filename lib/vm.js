var item = Vue.component("list-item", {
	props: ["name", "count", "goal", "updategoal", "reduce", "increment", "index", "deleteitem", "whichmenu", "showthismenu"],
	computed:{
		showorhide: function(){
	...
	template: `
		<li class="mx-auto my-2 w-50 itemElement border border-secondary px-3 py-1" :itemIndex="index">
			<div class="flex-row flex-baseline flex-split">
				<h3 class="dragger width-150">{{name}}</h3>
				<div class="progress w-25" :class="showgoalprogress">
			...
			<div :class="showorhide" class="flex-row flex-bottom flex-spread w-50 mx-auto">
				...
				<!-- <i class="fa fa-sticky-note-o fa-2x pointer"></i> -->
			</div>
		</li>`
});
...
// TODO: animate -- on open & close of menu?
// TODO: be able to rename an item
// TODO: create reset and save at new year > simply refers to new json?
// TODO: random quote per day from own list
// TODO: make this my home page
